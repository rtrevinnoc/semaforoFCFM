...
if __name__ == "__main__":
    ...
    try:
        ...
        exit(1)
    # Definir el criterio para eliminar el documento. SIGUE EN CONSTRUCCIÓN DE AQUÍ A LÍNEA 64
        ...
        while completed_flag:
            ...
            if not semaforo:
                ...
                new_semaforo = {
                    ...
                    "zone": "a2",
                    "cruce_id": 124535363,
                    "priority": 1  # Asignación de prioridad inicial
                }
            ...
            # Modo automático
                ...
                if semaforo["state"] == 1:  # Verde
                    ...
                    # Verificar si hay semáforos de mayor prioridad en verde en la misma zona
                    ...
                    otro_con_mayor_prioridad_en_verde = collection.find_one(
                        {
                            "cruce_id": semaforo["cruce_id"],
                            "state": 2,   #verificar que esté en amarillo
                            "priority": {"$lt": semaforo["priority"]}  # Prioridad mayor
                        }
                    )
